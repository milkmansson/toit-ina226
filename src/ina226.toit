...
class Ina226:
  ...
  */
  ...
  /** 'Triggered' mode - used while configuring $set-measure-mode. */
  static MODE-TRIGGERED                        ::= 0b011
  /** 'Continuous' mode - used while configuring $set-measure-mode. */
  static MODE-CONTINUOUS                       ::= 0b111
  ...
  */
  ...
  static REG-CONFIG_                           ::= 0x00  //RW  // All-register reset, shunt voltage and bus voltage ADC conversion times and averaging, operating mode.
  ...
  static REG-LOAD-POWER_                       ::= 0x03  //R   // Value of the calculated power being delivered to the load.
  static REG-SHUNT-CURRENT_                    ::= 0x04  //R   // Value of the calculated current flowing through the shunt resistor.
  static REG-CALIBRATION_                      ::= 0x05  //RW  // Sets full-scale range and LSB of current and power measurements. Overall system calibration.
  static REG-MASK-ENABLE_                      ::= 0x06  //RW  // Alert configuration and Conversion Ready flag.
  static REG-ALERT-LIMIT_                      ::= 0x07  //RW  // Limit value to compare to the selected Alert function.
  ...
  // Die & Manufacturer Info Masks for REG-DIE-ID_
  ...
  */
  get-sampling-rate -> int:
    return read-register_ REG-CONFIG_ --mask=CONF-AVERAGE-MASK_
  ...
  */
  set-bus-conversion-time code/int -> none:
    write-register_ REG-CONFIG_ code --mask=CONF-BUSVC-MASK_
  ...
  */
  get-bus-conversion-time -> int:
    return read-register_ REG-CONFIG_ --mask=CONF-BUSVC-MASK_
  ...
  */
  set-shunt-conversion-time code/int -> none:
    write-register_ REG-CONFIG_ code --mask=CONF-SHUNTVC-MASK_
  ...
  */
  get-shunt-conversion-time -> int:
    return read-register_ REG-CONFIG_ --mask=CONF-SHUNTVC-MASK_
  ...
  */
  trigger-measurement --wait/bool=(get-measure-mode == MODE-TRIGGERED) -> none:
    ...
    REG-value   := reg_.read-u16-be REG-MASK-ENABLE_
  ...
  */
  set-shunt-over-voltage-alert limit/float -> none:
    ...
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-SHUNT-OVER-VOLTAGE_
  ...
  */
  set-shunt-under-voltage-alert limit/float -> none:
    disable-all-alerts
    raw-limit/int := (limit / SHUNT-VOLTAGE-LSB_).round
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-SHUNT-UNDER-VOLTAGE_
    write-register_ REG-ALERT-LIMIT_ raw-limit
  ...
  */
  set-shunt-over-current-alert amps/float -> none:
    ...
    raw-limit = clamp-value_ raw-limit --upper=32767 --lower=-32768
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-SHUNT-OVER-VOLTAGE_
    write-register_ REG-ALERT-LIMIT_ raw-limit
  ...
  */
  set-bus-over-voltage-alert volts/float -> none:
    ...
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-BUS-OVER-VOLTAGE_
    write-register_ REG-ALERT-LIMIT_ raw-limit
  ...
  */
  set-bus-under-voltage-alert volts/float -> none:
    disable-all-alerts
    raw-limit/int := (volts / BUS-VOLTAGE-LSB_ ).round
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-BUS-UNDER-VOLTAGE_
    write-register_ REG-ALERT-LIMIT_ raw-limit
  ...
  */
  set-conversion-ready-alert -> none:
    disable-all-alerts
    write-register_ REG-MASK-ENABLE_ 1 --mask=ALERT-ENABLE-CONVERSION-READY_
  ...
  */
  ...
  When the Alert Latch Enable bit is set to Transparent mode, the Alert pin and
   Flag bit resets to the idle states when the fault has been cleared.  When the
   Alert Latch Enable bit is set to Latch mode, the Alert pin and Alert Flag bit
  ...
  */
  get-alert-pin-polarity -> int:
    return read-register_ REG-MASK-ENABLE_ --mask=ALERT-PIN-POLARITY_
  ...
  */
  is-conversion-ready -> bool:
    raw/int := read-register_ REG-MASK-ENABLE_ --mask=CONVERSION-READY-ALERT-FLAG_
    return raw == 1

  /**
  Whether an overflow alert exists.
  */
  is-alert-overflow  -> bool:
    raw/int := read-register_ REG-MASK-ENABLE_ --mask=MATH-OVERFLOW-ALERT-FLAG_
    return raw == 1
  ...
  */
  ...
  /**
  Returns us for supplied TIMING-*-US register values 0..7.
  */
